globalThis.openNextDebug = false;globalThis.openNextVersion = "3.5.3";

// ../../node_modules/.pnpm/@opennextjs+aws@https+++pkg.pr.new+@opennextjs+aws@802/node_modules/@opennextjs/aws/dist/utils/error.js
...
// ../../node_modules/.pnpm/@opennextjs+aws@https+++pkg.pr.new+@opennextjs+aws@802/node_modules/@opennextjs/aws/dist/adapters/logger.js
function debug(...args) {
...
// ../../node_modules/.pnpm/@opennextjs+cloudflare@0.6.6_wrangler@4.91.0/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
import { DurableObject } from "cloudflare:workers";
var DEFAULT_MAX_REVALIDATION = 5;
var DEFAULT_REVALIDATION_TIMEOUT_MS = 1e4;
var DEFAULT_RETRY_INTERVAL_MS = 2e3;
var DEFAULT_MAX_NUM_REVALIDATIONS = 6;
var DurableObjectQueueHandler = class extends DurableObject {
  ...
  constructor(ctx, env) {
    ...
    this.maxRevalidationAttempts = env.NEXT_CACHE_DO_QUEUE_MAX_NUM_REVALIDATIONS ? parseInt(env.NEXT_CACHE_DO_QUEUE_MAX_NUM_REVALIDATIONS) : DEFAULT_MAX_NUM_REVALIDATIONS;
    ...
    try {
      ...
      const response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "ed33a8b7ce98565621e23c691865913a",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "_MEicxKdGsSRWPQtS-gNJ");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "_MEicxKdGsSRWPQtS-gNJ");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "_MEicxKdGsSRWPQtS-gNJ");
