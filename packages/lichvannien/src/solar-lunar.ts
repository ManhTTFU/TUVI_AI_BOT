 ...
 * Port từ Hồ Ngọc Đức (https://www.informatik.uni-leipzig.de/~duc/amlich/).
 * Múi giờ +7 là chuẩn cho Việt Nam.
 */
...
/** Tính Julian Day Number từ ngày dương lịch (dd/mm/yy). */
...
/** Ngược của jdFromDate: JDN → [dd, mm, yy] dương lịch. */
...
export interface LunarDate {
  ...
  /** Năm âm */
  year: number;
  /** 1 nếu là tháng nhuận, 0 nếu không */
  leap: 0 | 1;
  /** Julian Day Number của ngày dương lịch gốc — dùng để tính can chi ngày. */
  jd: number;
}

/** Chuyển dương lịch → âm lịch Việt Nam (TZ +7). */
export function solarToLunar(dd: number, mm: number, yy: number): LunarDate {
  ...
  if (monthStart > dayNumber) {
    monthStart = getNewMoonDay(k, VN_TZ);
  }
